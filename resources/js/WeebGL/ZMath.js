...
const mat = ZMath.M4.identity(mat);
ZMath.M4.fromTranslation(ZMath.V3.set(1, 2, 3), mat);
...
ZMath.V2 = () => new Float32Array(2);

ZMath.V2.set = function(x, y, out = null) {
...
ZMath.V2.copy = function(a, out = null) {
    out ??= new Float32Array(2);
    out[0] = a[0];
    out[1] = a[1];
    return out;
...
ZMath.V2.add = function(a, b, out = null) {
    out ??= new Float32Array(2);
    out[0] = a[0] + b[0];
    out[1] = a[1] + b[1];
    return out;
...
ZMath.V2.sub = function(a, b, out = null) {
    out ??= new Float32Array(2);
    out[0] = a[0] - b[0];
    out[1] = a[1] - b[1];
    return out;
...
ZMath.V2.scale = function(a, s, out = null) {
    out ??= new Float32Array(2);
    out[0] = a[0] * s;
    out[1] = a[1] * s;
    return out;
...
ZMath.V2.dot = function(a, b) {
    return a[0] * b[0] + a[1] * b[1];
};

ZMath.V2.len = function(a) {
...
ZMath.V2.lerp = function(a, b, t, out = null) {
    out ??= new Float32Array(2);
    out[0] = a[0] + (b[0] - a[0]) * t;
    out[1] = a[1] + (b[1] - a[1]) * t;
    return out;
...
ZMath.V3 = () => new Float32Array(3);

ZMath.V3.UP      = new Float32Array([0, 1, 0]);
ZMath.V3.RIGHT   = new Float32Array([1, 0, 0]);
ZMath.V3.FORWARD = new Float32Array([0, 0, -1]);

ZMath.V3.set = function(x, y, z, out = null) {
...
ZMath.V3.copy = function(a, out = null) {
    out ??= new Float32Array(3);
    out[0] = a[0];
    out[1] = a[1];
    out[2] = a[2];
...
ZMath.V3.add = function(a, b, out = null) {
    out ??= new Float32Array(3);
    out[0] = a[0] + b[0];
    out[1] = a[1] + b[1];
    out[2] = a[2] + b[2];
...
ZMath.V3.sub = function(a, b, out = null) {
    out ??= new Float32Array(3);
    out[0] = a[0] - b[0];
    out[1] = a[1] - b[1];
    out[2] = a[2] - b[2];
...
ZMath.V3.mul = function(a, b, out = null) {
    out ??= new Float32Array(3);
    out[0] = a[0] * b[0];
    out[1] = a[1] * b[1];
    out[2] = a[2] * b[2];
...
ZMath.V3.scale = function(a, s, out = null) {
    out ??= new Float32Array(3);
    out[0] = a[0] * s;
    out[1] = a[1] * s;
    out[2] = a[2] * s;
...
ZMath.V3.dot = function(a, b) {
    return a[0] * b[0] + a[1] * b[1] + a[2] * b[2];
};

ZMath.V3.cross = function(a, b, out = null) {
    out ??= new Float32Array(3);
...
ZMath.V3.distance = function(a, b) {
    const dx = b[0] - a[0];
    const dy = b[1] - a[1];
    const dz = b[2] - a[2];
...
ZMath.V3.lerp = function(a, b, t, out = null) {
    out ??= new Float32Array(3);
    out[0] = a[0] + (b[0] - a[0]) * t;
    out[1] = a[1] + (b[1] - a[1]) * t;
    out[2] = a[2] + (b[2] - a[2]) * t;
...
ZMath.V4 = () => new Float32Array(4);

ZMath.V4.set = function(x, y, z, w, out = null) {
...
ZMath.V4.copy = function(a, out = null) {
    out ??= new Float32Array(4);
    out[0] = a[0];
    out[1] = a[1];
    out[2] = a[2];
...
ZMath.V4.add = function(a, b, out = null) {
    out ??= new Float32Array(4);
    out[0] = a[0] + b[0];
    out[1] = a[1] + b[1];
    out[2] = a[2] + b[2];
...
ZMath.V4.sub = function(a, b, out = null) {
    out ??= new Float32Array(4);
    out[0] = a[0] - b[0];
    out[1] = a[1] - b[1];
    out[2] = a[2] - b[2];
...
ZMath.V4.scale = function(a, s, out = null) {
    out ??= new Float32Array(4);
    out[0] = a[0] * s;
    out[1] = a[1] * s;
    out[2] = a[2] * s;
...
ZMath.V4.dot = function(a, b) {
    return a[0] * b[0] + a[1] * b[1] + a[2] * b[2] + a[3] * b[3];
};

ZMath.V4.len = function(a) {
...
ZMath.Q = () => new Float32Array(4);

ZMath.Q.identity = function(out = null) {
    out ??= new Float32Array(4);
    out[0] = 0;
    out[1] = 0;
    out[2] = 0;
...
ZMath.Q.copy = function(a, out = null) {
    out ??= new Float32Array(4);
    out[0] = a[0];
    out[1] = a[1];
    out[2] = a[2];
...
ZMath.Q.mul = function(a, b, out = null) {
    out ??= new Float32Array(4);
...
ZMath.Q.invert = function(a, out = null) {
    out ??= new Float32Array(4);
    const dot = a[0] * a[0] + a[1] * a[1] + a[2] * a[2] + a[3] * a[3];
    const inv = dot > ZMath.EPSILON ? 1 / dot : 0;
    out[0] = -a[0] * inv;
    out[1] = -a[1] * inv;
    out[2] = -a[2] * inv;
    out[3] =  a[3] * inv;
...
ZMath.Q.fromAxisAngle = function(axis, rad, out = null) {
    out ??= new Float32Array(4);
    const half = rad * 0.5;
...
ZMath.Q.fromEuler = function(x, y, z, out = null) {
    out ??= new Float32Array(4);
...
ZMath.Q.fromM4 = function(m, out = null) {
    out ??= new Float32Array(4);
...
ZMath.Q.toEulerYPR = function(q, out = null) {
    out ??= new Float32Array(3);
    ...
    out[0] = yaw * ZMath.RAD2DEG;
    out[1] = pitch * ZMath.RAD2DEG;
    out[2] = roll * ZMath.RAD2DEG;
    return out;
};

ZMath.Q.transformV3 = function(q, v, out = null) {
    out ??= new Float32Array(3);
...
ZMath.Q.slerp = function(a, b, t, out = null) {
    out ??= new Float32Array(4);
...
ZMath.M4 = () => new Float32Array(16);

ZMath.M4.identity = function(out = null) {
...
ZMath.M4.mul = function(a, b, out = null) {
    out ??= new Float32Array(16);
...
ZMath.M4.transpose = function(a, out = null) {
    out ??= new Float32Array(16);
    if (out === a) {
        let t;
        t = a[1];  a[1]  = a[4];  a[4]  = t;
...
ZMath.M4.invert = function(a, out = null) {
    out ??= new Float32Array(16);
    const a00 = a[0],  a01 = a[1],  a02 = a[2],  a03 = a[3];
    const a10 = a[4],  a11 = a[5],  a12 = a[6],  a13 = a[7];
    const a20 = a[8],  a21 = a[9],  a22 = a[10], a23 = a[11];
    ...
    if (Math.abs(det) <= ZMath.EPSILON) return null;
    det = 1 / det;
...
ZMath.M4.fromTranslation = function(v, out = null) {
    out = ZMath.M4.identity(out);
    out[12] = v[0];
    out[13] = v[1];
    out[14] = v[2];
    return out;
...
ZMath.M4.fromScaling = function(v, out = null) {
    out = ZMath.M4.identity(out);
    out[0]  = v[0];
    out[5]  = v[1];
    out[10] = v[2];
...
ZMath.M4.fromRotationX = function(rad, out = null) {
    out = ZMath.M4.identity(out);
...
ZMath.M4.fromRotationY = function(rad, out = null) {
    out = ZMath.M4.identity(out);
    const c = Math.cos(rad), s = Math.sin(rad);
    out[0]  =  c; out[2]  = -s;
    out[8]  =  s; out[10] =  c;
...
ZMath.M4.fromRotationZ = function(rad, out = null) {
    out = ZMath.M4.identity(out);
    const c = Math.cos(rad), s = Math.sin(rad);
    out[0] =  c; out[1] = s;
    out[4] = -s; out[5] = c;
...
ZMath.M4.fromQuat = function(q, out = null) {
    out ??= new Float32Array(16);
    const x = q[0], y = q[1], z = q[2], w = q[3];
...
ZMath.M4.fromTRS = function(pos, rotQ, scale, out = null) {
    out ??= new Float32Array(16);
...
ZMath.M4.rotateX = function(m, rad, out = null) {
    const r = ZMath.M4.fromRotationX(rad);
    return ZMath.M4.mul(m, r, out);
};

ZMath.M4.rotateY = function(m, rad, out = null) {
    const r = ZMath.M4.fromRotationY(rad);
    return ZMath.M4.mul(m, r, out);
};

ZMath.M4.rotateZ = function(m, rad, out = null) {
    const r = ZMath.M4.fromRotationZ(rad);
    return ZMath.M4.mul(m, r, out);
};

ZMath.M4.rotateQ = function(m, q, out = null) {
    const r = ZMath.M4.fromQuat(q);
    return ZMath.M4.mul(m, r, out);
};
...
ZMath.M4.ortho = function(left, right, bottom, top, near, far, out = null) {
    out ??= new Float32Array(16);
...
ZMath.M4.lookAt = function(eye, target, up, out = null) {
    out ??= new Float32Array(16);
...
ZMath.M4.transformV2 = function(m, v, out = null) {
    out ??= new Float32Array(2);
    const x = v[0], y = v[1];
...
ZMath.M4.transformV3 = function(m, v, out = null) {
    out ??= new Float32Array(3);
    const x = v[0], y = v[1], z = v[2];
...
ZMath.M4.transformV4 = function(m, v, out = null) {
    out ??= new Float32Array(4);
